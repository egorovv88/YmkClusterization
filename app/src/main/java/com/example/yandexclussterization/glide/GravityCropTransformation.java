...
public class GravityCropTransformation extends BitmapTransformation {
    ...
    public GravityCropTransformation(@FloatRange(from = 0.0, to = 1.0) float yPercentage) {
    ...
    protected Bitmap transform(@NonNull BitmapPool pool, @NonNull Bitmap toTransform, int outWidth, int outHeight) {
        return crop(pool, toTransform, outWidth, outHeight, yPercentage);
    }
     ...
     */
    private static Bitmap crop(BitmapPool pool, Bitmap inBitmap, int width, int height, float yPercentage) {
    ...
    public boolean equals(Object o) {
        return o instanceof GravityCropTransformation;
    }
}